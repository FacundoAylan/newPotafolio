  ...
  return (
    <div className="w-full h-full flex">
      ...
      <section className="pt-14 w-1/2 h-screen flex justify-center items-center">
        <div className="relative w-[98%] h-[85%]">
          <Rnd
            default={{ x: 0, y: 0, width: '100%', height: '100%' }}
            className=" backdrop-blur-md bg-[#101010] border-6  rounded-[10px] border-[#039ea6] border-double shadow-[0px_0px_10px_4px_#039ea6] font-mono text-green-400"
            style={{ cursor }}
          >
